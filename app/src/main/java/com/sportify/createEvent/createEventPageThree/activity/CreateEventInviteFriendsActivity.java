...
public class CreateEventInviteFriendsActivity extends AppCompatActivity implements CreateEventInviteFriendsView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         *  Update friend list
         */
        myArrayAdapter = new MyArrayAdapterInviteFriends(this, R.layout.create_event_friend_list_item, null);
    ...
    public void showFriends(ArrayList friends) {
        friendArray = friends;
        myArrayAdapter = new MyArrayAdapterInviteFriends(this, R.layout.create_event_friend_list_item, friends);
